...
import { MobilButton } from '@/components/portfolio/MobilButton';
    ...
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 grid md:grid-cols-12 gap-8 md:gap-16 items-center relative z-40 min-h-[calc(100vh-80px)] md:min-h-[calc(100vh-96px)]">
          ...
          {/* TEXTO - Versión limpia y humilde */}
          <motion.div
          ...
          >
            <div className="space-y-2">
              ...
              {/* ← BADGE NEUTRO DEBAJO DEL TÍTULO */}
              <motion.div 
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.6, duration: 0.8 }}
                className="inline-flex items-center gap-3 px-5 py-2.5 md:px-6 md:py-3 bg-slate-900/70 backdrop-blur-3xl border border-cyan-400/30 rounded-3xl"
              >
                ...
                <span className="text-cyan-300 font-medium tracking-[2px] text-xs sm:text-sm">
                  DESARROLLADOR WEB • ANALISTA SEO
                </span>
              </motion.div>
            </div>
          </motion.div>
